...
Data types tell JavaScript what kind of information we are working with.
...
null
undefined
Primitives are NOT collections. Arrays and objects come later in their own lessons.

2. Main Data Types in this Lesson
Type Example Description

string "John" Text inside quotes number 32, 3.14 Any numeric value boolean true, false Yes/No values undefined undefined Exists but has no value yet null null Intentionally empty
...
You wouldn't add "Maria" + "Carlos" like numbers --- JavaScript needs to know the type first.
...
Update eveningPlan to a string.
Assign a value to favoriteSnack.
