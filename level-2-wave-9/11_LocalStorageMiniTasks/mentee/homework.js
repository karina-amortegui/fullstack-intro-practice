...
saveQuoteBtn.addEventListener("click", () => {
  const currentQuote = quoteInput.value;
  localStorage.setItem("favoriteQuote", currentQuote);
  
  if(currentQuote) {
    quoteDisplay.textContent = currentQuote;
  } else {
    quoteDisplay.textContent = "Nothing to save.";
  }
});
...
clearQuoteBtn.addEventListener("click", () => {
  ...
  quoteInput.value = "";
  quoteDisplay.textContent = "Not saved yet.";
});