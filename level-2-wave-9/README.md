...
+ addition 5 + 3 Add numbers OR join strings - subtraction 10 - 4 Subtract numbers * multiplication 6 * 2 Multiply numbers / division 20 / 5 Divide numbers % remainder 7 % 3 Remainder after division += plus equals x += 2 Same as x = x + 2 -= minus equals x -= 1 Same as x = x - 1
...
Calculate totalExpenses using +.
Calculate moneyLeft using -.
Log a clear summary:
<!-- -->
--- SIMPLE BUDGET ---
...
Total expenses: 8500
Money left: 3500
Update one expense using +=.
Recalculate totals and log the updated result.
This lesson focuses only on math with variables --- no conditionals or loops yet.